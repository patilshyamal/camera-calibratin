...
def calibrate(chessboard_path, show_chessboard=False):
    ...
    np.savez("MultiMatrix.npz", camera_matrix=k, distortion_coefficients=d, r_vectors=rvecs, t_vectors=tvecs, image_dimensions=dims)
...
if __name__ == '__main__':
    ...
    calibrate('./Chessboards', show_chessboard=True)
